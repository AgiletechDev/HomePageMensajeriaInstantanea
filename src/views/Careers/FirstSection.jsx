...
const ContainerSection = ({image, title, paragraph, marginLeft})=> (
  ...
  >
    ...
    <Typography variant='h5' color='red' fontWeight='600' marginBottom='20px'>{title}</Typography>
    ...
    <>
        ...
        >
            ...
            >
                ...
                Millions of people use Smessenger every day to share the moments that
                matter in their lives. Join an organization that empowers users by
        ...
        >
          ...
          <Typography variant='h4' fontWeight='600' marginTop='150px' textAlign='center'>
            Open Roles
          </Typography>
          ...
          <Typography fontSize='10px' textAlign='center' marginTop='30px'>Sorry, we are not seeking interns at this time.</Typography>
